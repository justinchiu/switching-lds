# First, adapted from https://github.com/huggingface/transformers/blob/master/examples/language-modeling/run_mlm.py
# Then, adapted from https://github.com/yang-zhang/lightning-language-modeling/blob/main/data.py

# Causal language modeling data batcher
...
class LMDataModule(pl.LightningDataModule):
    def __init__(
        self, model_name_or_path, train_file, validation_file, line_by_line, pad_to_max_length,
